...
RcppExport SEXP _reverseC_threaded_mediate_helper(SEXP envSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::Environment& >::type env(envSEXP);
    threaded_mediate_helper(env);
    return R_NilValue;
END_RCPP
}
// cpp_mult
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_reverseC_threaded_mediate_helper", (DL_FUNC) &_reverseC_threaded_mediate_helper, 1},
